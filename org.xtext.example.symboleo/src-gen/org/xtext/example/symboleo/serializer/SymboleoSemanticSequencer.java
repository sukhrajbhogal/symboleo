 ...
 */
package org.xtext.example.symboleo.serializer;
...
import org.xtext.example.symboleo.symboleo.Attribute;
import org.xtext.example.symboleo.symboleo.BasicType;
import org.xtext.example.symboleo.symboleo.Declar;
import org.xtext.example.symboleo.symboleo.DeclarPair;
...
public class SymboleoSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == SymboleoPackage.eINSTANCE)
			...
			case SymboleoPackage.ENUMERATION:
				...
				return; 
			case SymboleoPackage.EVENT_PROP:
				sequence_EventProp(context, (EventProp) semanticObject); 
				return; 
			case SymboleoPackage.INT_CONST:
			...
			case SymboleoPackage.OBLIGATION:
				...
				return; 
			case SymboleoPackage.ONTO_CTYPE:
				sequence_OntoCType(context, (OntoCType) semanticObject); 
				return; 
			case SymboleoPackage.PARAMETER:
				sequence_Parameter(context, (org.xtext.example.symboleo.symboleo.Parameter) semanticObject); 
				return; 
			case SymboleoPackage.POINT:
				sequence_Point(context, (Point) semanticObject); 
				return; 
			case SymboleoPackage.POINT_CONST:
	...
	protected void sequence_Attribute(ISerializationContext context, Attribute semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SymboleoPackage.Literals.ATTRIBUTE__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleoPackage.Literals.ATTRIBUTE__NAME));
			if (transientValues.isValueTransient(semanticObject, SymboleoPackage.Literals.ATTRIBUTE__ATTRIBUTE_TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleoPackage.Literals.ATTRIBUTE__ATTRIBUTE_TYPE));
		}
	...
	protected void sequence_DeclarPair(ISerializationContext context, DeclarPair semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SymboleoPackage.Literals.DECLAR_PAIR__ATTR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleoPackage.Literals.DECLAR_PAIR__ATTR));
			if (transientValues.isValueTransient(semanticObject, SymboleoPackage.Literals.DECLAR_PAIR__PARAM) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleoPackage.Literals.DECLAR_PAIR__PARAM));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getDeclarPairAccess().getAttrIDTerminalRuleCall_0_0(), semanticObject.getAttr());
		feeder.accept(grammarAccess.getDeclarPairAccess().getParamParameterIDTerminalRuleCall_2_0_1(), semanticObject.eGet(SymboleoPackage.Literals.DECLAR_PAIR__PARAM, false));
		feeder.finish();
	}
	...
	protected void sequence_DomainType(ISerializationContext context, DomainType semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SymboleoPackage.Literals.DOMAIN_TYPE__SUPER_TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleoPackage.Literals.DOMAIN_TYPE__SUPER_TYPE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getDomainTypeAccess().getSuperTypeDomainConceptIDTerminalRuleCall_0_1(), semanticObject.eGet(SymboleoPackage.Literals.DOMAIN_TYPE__SUPER_TYPE, false));
		feeder.finish();
	}
	...
	protected void sequence_IntConst(ISerializationContext context, IntConst semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SymboleoPackage.Literals.INT_CONST__TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleoPackage.Literals.INT_CONST__TYPE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	 ...
	 */
	protected void sequence_Parameter(ISerializationContext context, org.xtext.example.symboleo.symboleo.Parameter semanticObject) {
		if (errorAcceptor != null) {
	...
	protected void sequence_PointConst(ISerializationContext context, PointConst semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SymboleoPackage.Literals.POINT_CONST__TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleoPackage.Literals.POINT_CONST__TYPE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_cEvent(ISerializationContext context, cEvent semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SymboleoPackage.Literals.CEVENT__CONTR_EVENT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleoPackage.Literals.CEVENT__CONTR_EVENT));
			if (transientValues.isValueTransient(semanticObject, SymboleoPackage.Literals.CEVENT__CONTR_NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleoPackage.Literals.CEVENT__CONTR_NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_cState(ISerializationContext context, cState semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SymboleoPackage.Literals.CSTATE__CONTR_STATE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleoPackage.Literals.CSTATE__CONTR_STATE));
			if (transientValues.isValueTransient(semanticObject, SymboleoPackage.Literals.CSTATE__CONTRACT_NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleoPackage.Literals.CSTATE__CONTRACT_NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_oEvent(ISerializationContext context, oEvent semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SymboleoPackage.Literals.OEVENT__OBL_EVENT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleoPackage.Literals.OEVENT__OBL_EVENT));
			if (transientValues.isValueTransient(semanticObject, SymboleoPackage.Literals.OEVENT__OBL_NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleoPackage.Literals.OEVENT__OBL_NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_oState(ISerializationContext context, oState semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SymboleoPackage.Literals.OSTATE__OBL_STATE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleoPackage.Literals.OSTATE__OBL_STATE));
			if (transientValues.isValueTransient(semanticObject, SymboleoPackage.Literals.OSTATE__OBL_NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleoPackage.Literals.OSTATE__OBL_NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_pEvent(ISerializationContext context, pEvent semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SymboleoPackage.Literals.PEVENT__POW_EVENT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleoPackage.Literals.PEVENT__POW_EVENT));
			if (transientValues.isValueTransient(semanticObject, SymboleoPackage.Literals.PEVENT__POW_NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleoPackage.Literals.PEVENT__POW_NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_pState(ISerializationContext context, pState semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SymboleoPackage.Literals.PSTATE__POW_STATE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleoPackage.Literals.PSTATE__POW_STATE));
			if (transientValues.isValueTransient(semanticObject, SymboleoPackage.Literals.PSTATE__POW_NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleoPackage.Literals.PSTATE__POW_NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);

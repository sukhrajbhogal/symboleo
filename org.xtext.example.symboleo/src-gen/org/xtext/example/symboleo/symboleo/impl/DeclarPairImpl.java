 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.symboleo.symboleo.impl.DeclarPairImpl#getAttr <em>Attr</em>}</li>
 *   <li>{@link org.xtext.example.symboleo.symboleo.impl.DeclarPairImpl#getParam <em>Param</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeclarPairImpl extends MinimalEObjectImpl.Container implements DeclarPair
{
  ...
  {
    return SymboleoPackage.Literals.DECLAR_PAIR;
  }
  ...
  public void setAttr(String newAttr)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SymboleoPackage.DECLAR_PAIR__ATTR, oldAttr, attr));
  }
  ...
  public Parameter getParam()
  {
    if (param != null && param.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SymboleoPackage.DECLAR_PAIR__PARAM, oldParam, param));
      }
    }
    return param;
  }
  ...
  public void setParam(Parameter newParam)
  {
    ...
    param = newParam;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SymboleoPackage.DECLAR_PAIR__PARAM, oldParam, param));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SymboleoPackage.DECLAR_PAIR__ATTR:
        return getAttr();
      case SymboleoPackage.DECLAR_PAIR__PARAM:

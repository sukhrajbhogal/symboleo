 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.symboleo.symboleo.impl.PropositionImpl#getJunctions <em>Junctions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropositionImpl extends MinimalEObjectImpl.Container implements Proposition
{
  ...
  public EList<Junction> getJunctions()
  {
    if (junctions == null)
    {
      junctions = new EObjectContainmentEList<Junction>(Junction.class, this, SymboleoPackage.PROPOSITION__JUNCTIONS);
    }
    return junctions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SymboleoPackage.PROPOSITION__JUNCTIONS:
